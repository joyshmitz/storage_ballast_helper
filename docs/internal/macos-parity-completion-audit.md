...
- The `v0.4.14` release credential gap found during this audit has been fixed:
  ...
  to Developer-ID sign both staged `v0.4.14` macOS binaries with hardened
  runtime.
